        ...
        <div class="container flex flex-col items-center justify-between px-4 py-6 mx-auto md:flex-row">
            <ul class="flex flex-col items-center md:flex-row">
                ...
                <li class="mt-3 md:ml-16 md:mt-0">
                    <router-link :to="{ name: 'movies' }" class="hover:text-gray-300">Movies</router-link>
                </li>
                <li class="mt-3 md:ml-6 md:mt-0">
                    <router-link :to="{ name: 'tv' }" class="hover:text-gray-300">Tv Shows</router-link>
                </li>
                <li class="mt-3 md:ml-6 md:mt-0">
                    <router-link :to="{ name: 'actors' }" class="hover:text-gray-300">Actors</router-link>
                </li>
            </ul>
            <div class="flex flex-col items-center md:flex-row">
                <div class="relative mt-3 md:mt-0">
                    <input
                        type="text"
                        class="w-64 px-4 py-1 pl-8 bg-gray-800 rounded-full focus:outline-none focus:ring"
                        placeholder="Search">
